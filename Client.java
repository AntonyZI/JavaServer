...
public class Client {
    ...
    public Client(String ipAddress, int port){
        ...
        clientOutputStreams = new OutputStream[1];
    ...
    public void enableSocket(int n){
        try {
            ...
            clientOutputStreams[0] = clientSockets[n].getOutputStream();
            clientDataOutputStreams[0] = new DataOutputStream(clientOutputStreams[0]);
